...
import net.lax1dude.eaglercraft.v1_8.aether.config.AetherConfigManager;
...
public class AetherScreen extends GuiScreen {
    ...
    private net.lax1dude.eaglercraft.v1_8.aether.gui.AetherPanelManager panelManager;
    private net.lax1dude.eaglercraft.v1_8.aether.gui.AetherNotificationManager notifications;
    ...
    public void initGui() {
        ...
        this.panelManager = new net.lax1dude.eaglercraft.v1_8.aether.gui.AetherPanelManager(this.width, this.height);
        this.notifications = new net.lax1dude.eaglercraft.v1_8.aether.gui.AetherNotificationManager(fr);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        String title = "✦ AETHER";
        int titleColor = net.lax1dude.eaglercraft.v1_8.aether.theme.AetherTheme.TEXT;
        ...
        drawRect(lineX, lineY, lineX + lineW, lineY + 1, net.lax1dude.eaglercraft.v1_8.aether.theme.AetherTheme.BORDER);

        // Panel manager renders panels and their children
        if (panelManager == null) panelManager = new net.lax1dude.eaglercraft.v1_8.aether.gui.AetherPanelManager(this.width, this.height);
