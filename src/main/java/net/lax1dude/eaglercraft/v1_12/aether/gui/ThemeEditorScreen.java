...
public class ThemeEditorScreen extends GuiScreen {
    ...
    @Override public void initGui() { this.buttonList.clear(); this.colorPicker = new AetherColorPicker(fr, AetherTheme.ACCENT_VIOLET); this.colorPicker.setPosition(this.width/2 - 90, this.height/2 - 60); this.colorPicker.setSize(180,18); btnSave = new GuiButton(0,this.width/2 - 50,this.height/2 + 40,100,20,"Save Theme"); this.buttonList.add(btnSave); }
